...
VOLUME /tmp
ARG DEPENDENCY=/vitinyurl/backend/target/dependency
...
ENTRYPOINT ["java","-cp","app:app/lib/*","com.virtualidentity.vitinyurl.TinyURLBootupApplication"]